...
public class ExtentReportManager {
	...
	public static void startReport()
	{
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/Reports/WebReports/"+dateStamp+"/"+"QM-"+timeStamp+".html");
...
*/	
		...
		extent.setSystemInfo("user_name", "Kanvitha");
		spark.config().setDocumentTitle("QM_html_Report");
		spark.config().setReportName("QM_html_Report");
